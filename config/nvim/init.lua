...
vim.keymap.set('n', 'gs', ':vsplit | lua vim.lsp.buf.definition()<CR>', { silent = true, desc = 'Go to definition in vertical split' })
vim.keymap.set('n', 'gS', ':split | lua vim.lsp.buf.definition()<CR>', { silent = true, desc = 'Go to definition in horizontal split' })
...
require('lazy').setup({
  ...
  --
  --     vim.keymap.set('n', '<leader>c', osc52.copy_operator, { expr = true, desc = '[C]opy to clipboard' })
  --     vim.keymap.set('n', '<leader>cc', '<leader>c_', { remap = true, desc = '[C]opy to clipboard' })
  --     vim.keymap.set('v', '<leader>c', osc52.copy_visual, { desc = '[C]opy to clipboard' })
  --   end,
  -- },
